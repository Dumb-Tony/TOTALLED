...
6. **Visuals:** low-resolution procedural body with node-bound opaque glass, trim and lamp lenses; visual wheel openings and rotating textured wheels, but no physical wheel wells, dashboard, glass shards, sounds or particles. Make deformation convincing before producing art.
